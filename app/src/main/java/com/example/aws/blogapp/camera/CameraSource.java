...
package com.example.aws.blogapp.camera;
...
public class CameraSource {
    ...
    private int cameraDirection = CAMERA_FACING_BACK;
    ...
    public static class Builder {
        ...
        public Builder setFacing(int facing) {
            ...
            cameraSource.cameraDirection = facing;
            return this;
        }
    ...
    public CameraSource start() throws IOException {
        synchronized (cameraLock) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                ...
                mycamera.setPreviewTexture(dummySurfaceTexture);
            } else {
                dummySurfaceView = new SurfaceView(context);
                mycamera.setPreviewDisplay(dummySurfaceView.getHolder());
            }
        ...
        synchronized (cameraLock) {
            ...
            if (mycamera != null) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                        mycamera.setPreviewTexture(null);
    ...
    public void takePicture(ShutterCallback shutter, PictureCallback jpeg) {
        synchronized (cameraLock) {
            if (mycamera != null) {
                ...
                mycamera.takePicture(startCallback, null, null, doneCallback);
            }
        }
    }
    ...
    public boolean setAutoFocusMoveCallback(@Nullable AutoFocusMoveCallback cb) {
        ...
        synchronized (cameraLock) {
            if (mycamera != null) {
                ...
                mycamera.setAutoFocusMoveCallback(autoFocusMoveCallback);
            }
        }
    ...
    private class PictureDoneCallback implements Camera.PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            synchronized (cameraLock) {
                if (CameraSource.this.mycamera != null) {
                    CameraSource.this.mycamera.startPreview();
                }
            }
        }
    }
    ...
    private Camera createCamera() {
        int requestedCameraId = getIdForRequestedCamera(cameraDirection);
    ...
    private static int getIdForRequestedCamera(int direction) {
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    mycamera.addCallbackBuffer(data.array());
                }
            }
        }
    }
